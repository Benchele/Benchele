...
//
//    // Verificar tripleta
//    if (med + 2 <= fin and arr[med] == arr[med+1] and arr[med] == arr[med+2]) {
//        return arr[med];
//    }
//
//    // Caso normal de pares
//    if (arr[med] == arr[med+1]) {
//        // Este par está bien → triple más a la derecha
//        return encontrarTriple(arr, med + 2, fin);
//    } else {
//        // Par roto → triple a la izquierda
//        return encontrarTriple(arr, ini, med);
//    }
}
