...
void recorridoEnPostOrdenDosPilas(ArbolBinarioBusqueda arbol){
    if(esArbolVacio(arbol.arbolBinario))return;
...
void recorridoEnPostOrdenUnaPila(ArbolBinarioBusqueda arbol){
    if(esArbolVacio(arbol.arbolBinario))return;
    ...
    while (true) {
        ...
        if(pRec->derecha and ultimo.numero != pRec->derecha->elemento.numero){
            pRec = pRec->derecha;
        }
        else{
...
void recorridoPostOrden(){ //IDR
    ...
    recorridoEnPostOrdenDosPilas(arbol);
    
    
    recorridoEnPostOrdenUnaPila(arbol);
