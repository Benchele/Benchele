...
bool compara(struct Orden k, struct Orden g) {
    //Primero van las de mayor prioridad (menor numero), luego las de mayor cantidad de botellas
    return k.prioridad < g.prioridad or (k.prioridad == g.prioridad and k.cantidadBotellas > g.cantidadBotellas);
}
