...
namespace BenchelePersistance.DAOImpl
{
    public abstract class DAOImplBase
    {
        ...
        //Nuevo hecho por mi
        // Procedures DML
        protected void EjecutarProcedimientoAlmacenado(string sql, bool usarTransaccion)
        {
            Action<object> incluirValorDeParametros = null;
            object parametros = null;
            this.EjecutarProcedimientoAlmacenado(sql, incluirValorDeParametros, parametros, usarTransaccion);
        }

        protected void EjecutarProcedimientoAlmacenado(string sql,
            Action<object> incluirValorDeParametros,
            object parametros,
            bool usarTransaccion)
        {
            try
            {
                if (usarTransaccion)
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception("Error al intentar ejecutar procedimiento almacenado: " + ex.Message);
            }
            finally
            {
                this.CerrarConexion();
        ...
        // Procedures SELECT
        protected IList<Object> EjecutarProcedimientoAlmacenadoSELECT(string sql, bool usarTransaccion)
        {
            Action<object> incluirValorDeParametros = null;
            object parametros = null;
            return this.EjecutarProcedimientoAlmacenadoSELECT(sql, incluirValorDeParametros, parametros, usarTransaccion);
        }

        protected IList<Object> EjecutarProcedimientoAlmacenadoSELECT(string sql,
            Action<object> incluirValorDeParametros,
            object parametros,
            bool usarTransaccion)
        {
